...
public class DamageModel extends ForwardingBakedModel {
	...
	public void prepare(IBakedModel wrappedModel, TextureAtlasSprite sprite, IBlockState blockState, BlockPos blockPos) {
	...
	private static class DamageTransform implements RenderContext.QuadTransform {
		private TextureAtlasSprite damageSprite;

...
public abstract class MutableQuadViewImpl extends QuadViewImpl implements QuadEmitter, ShadeableQuad {
	...
	@Override
	public final MutableQuadViewImpl cullFace(EnumFacing face) {
		cullFace = face;
		nominalFace = face;
		return this;
	}

	public final MutableQuadViewImpl lightFace(EnumFacing face) {
		lightFace = face;
		return this;
	}

	@Override
	public final MutableQuadViewImpl nominalFace(EnumFacing face) {
		nominalFace = face;
		return this;
	}
